...
class Pasien extends CI_Controller
{
    ...
    $sql_rekamedis    = "SELECT tr.*,pd.no_rawat,pd.tanggal_daftar 
        ...
        $pdf->Image('http://localhost/puskesmas/assets/foto_profil/logo-rs.jpg', 75, 5, 30);
        //$pdf->Image('', )
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        $pdf->Cell(260, 7, 'PUSKESMAS CEMPAKA ARUM', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(40, 7, '', 0, 0, 'C');
        $pdf->Cell(275, 7, 'Jl.Griya cempaka arum, Rancanumpang, Gedebage No.2 Bandung', 0, 1, 'C');
        $pdf->Cell(80, 7, '', 0, 0, 'C');
        $pdf->Cell(190, 7, 'Telepon : (022) 63726389. E-mail: puskesmascempakaarum@gmail.com', 0, 1, 'C');
    ...
    function cetakkartu($id){
        ...
        $pdf->Cell(90,5,'PUSKESMAS CEMPAKA ARUM',0,0,'C');
        $pdf->Cell(10,5,'',0,0,'C');
        $pdf->setFont('Arial','B',10);
        $pdf->Cell(90,5,'KETENTUAN',0,1,'C');
        $pdf->setFont('Arial','B',8);
        $pdf->Cell(90,5,'Jl.Griya cempaka arum, Rancanumpang, Gedebage No.2 Bandung',0,0,'C');
        $pdf->Cell(10,5,'',0,0,'C');
        $pdf->setFont('Arial','',7);
